      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              <!-- Vertical Form --><br>
               <?php foreach($rumkit as $fas): ?>
              <?php echo form_open_multipart('administrator/rumkit/ubah/'.$fas->id_faskes);  ?>
                 
                     <?php $layanan = explode(', ',$fas->layanan); ?>
                      <?php $dokter = explode(', ',$fas->dokter); ?>
                  <div class="row">
                      <div class="col-6">
                        <label class="form-label" style="font-weight:bold;">ID Rumah Sakit</label>
                        <input type="text" class="form-control" name="id_faskes" value="<?php echo $fas->id_faskes ?>">
                      </div>

                      <div class="col-6">
                        <label class="form-label" style="font-weight:bold;">Nama Rumah Sakit</label>
                  ...
                  <div class="row">
                      ...
                      <div class="col-6">
                        <label class="form-label" style="font-weight:bold;">Nomor Telpon</label>
                        <input type="text" class="form-control" name="telpon" value="<?php echo $fas->telpon ?>">
                      </div>
                  </div>

                  <div class="col-12">
                    <label class="form-label" style="font-weight:bold;">Kecamatan</label>
                  ...
                  <div class="col-12" >
                    <label class="form-label" style="font-weight:bold;">Daftar Layanan</label>
                  ...
                  <div class="col-12">
                    <label class="form-label" style="font-weight:bold;">Jam Operasional</label>
                    <textarea class="form-control" name="jam" style="height: 100px;"><?php echo $fas->jam ?></textarea>
                  </div>
                  <div class="col-12">
                    <label class="form-label" style="font-weight:bold;">Daftar Dokter</label>
          ...
          <div class="card">
            <div class="card-body">
              <!-- Vertical Form --><br>
               ...
               <div class="col-12">
                    <label class="form-label" style="font-weight:bold;">Foto Fasilitas Kesehatan</label>
