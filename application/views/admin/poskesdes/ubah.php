      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              <!-- Vertical Form --><br>
               <?php foreach($poskesdes as $fas): ?>
              <?php echo form_open_multipart('administrator/poskesdes/ubah/'.$fas->id_faskes);  ?>
                 
                     <?php $layanan = explode(', ',$fas->layanan); ?>
                      <?php $dokter = explode(', ',$fas->dokter); ?>
                  <div class="row">
                      <div class="col-6">
                        <label class="form-label">ID Poskesdes</label>
                        <input type="text" class="form-control" name="id_faskes" value="<?php echo $fas->id_faskes ?>">
                      </div>

                      <div class="col-6">
                        <label class="form-label">Nama Poskesdes</label>
