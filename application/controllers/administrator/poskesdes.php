...
class Poskesdes extends CI_Controller{
	...
	public function index(){
		$where = "poskesdes";
		$data = array(
			'title' => 'Data Poskesdes',
			'isi'	=> 'admin/poskesdes/data',
			'poskesdes'=> $this->faskes_model->getByKategori($where)
		);
	...
	public function detail($id_faskes){
		...
		$data = array(
					'title'	=> 'Detail Poskesdes',
					'isi'	=> 'admin/poskesdes/detail',
					'poskesdes'=> $this->faskes_model->getDetail($where)
		);
		$this->load->view('adminTemplate/wrapper', $data, FALSE);
	}
	...
	public function tambah(){
		...
		if($this->form_validation->run()==TRUE){
			...
			{
				$data = array(
						'title' => 'Tambah Data poskesdes',
						'error_upload'	=>  $this->upload->display_errors(),
						'isi'	=> 'admin/poskesdes/tambah',
				...
				redirect('administrator/poskesdes');
			}
		}
				$data = array(
						'title' => 'Tambah Data poskesdes',
	...
	public function ubah($id_faskes){
		...
		if($this->form_validation->run()==TRUE){
			...
			if(!$this->upload->do_upload('foto'))
				{
					$data = array(
							'title' => 'Ubah Data poskesdes',
							'error_upload'	=>  $this->upload->display_errors(),
							'isi'	=> 'admin/poskesdes/ubah',
							'poskesdes'=> $this->faskes_model->getDetail($where),
							'kecamatan'=> $this->kecamatan_model->getAll()
					);
					$this->load->view('adminTemplate/wrapper', $data, FALSE);
